...
void makeSkims_pyPlotter(){
	...
	TFile *input(0);
	TString fname = "";
	std::string label ="ZGTo2LG_TuneCUETP8M1_13TeV-amcatnloFXFX-pythia8_ext1";   

	if( (label.find("TTJets_Dilept") != std::string::npos) || (label.find("DYJets") != std::string::npos) ){
        fname = "/cms/mchristos/ANN/Seesaw/2016/92X/MC_TTbarDY/ZGTo2LG_TuneCUETP8M1_13TeV-amcatnloFXFX-pythia8_ext1/analysisTree.root";   

      }else{
        fname = "/cms/mchristos/ANN/Seesaw/2016/92X/MC_notTTbarDY/ZGTo2LG_TuneCUETP8M1_13TeV-amcatnloFXFX-pythia8_ext1/analysisTree.root";   
     }
	...
	TFile *endfile = new TFile("/cms/mchristos/ANN/Seesaw/2016/92X/TMVAskims/pyPlotter/Backgrounds/ZGTo2LG_TuneCUETP8M1_13TeV-amcatnloFXFX-pythia8_ext1/analysisTree.root","RECREATE");
