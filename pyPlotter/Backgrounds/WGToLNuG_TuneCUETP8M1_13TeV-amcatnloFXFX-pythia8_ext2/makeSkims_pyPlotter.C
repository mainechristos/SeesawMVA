...
void makeSkims_pyPlotter(){
	...
	TFile *input(0);
	TString fname = "";
	std::string label ="WGToLNuG_TuneCUETP8M1_13TeV-amcatnloFXFX-pythia8_ext2";   

	if( (label.find("TTJets_Dilept") != std::string::npos) || (label.find("DYJets") != std::string::npos) ){
        fname = "/cms/mchristos/ANN/Seesaw/2016/92X/MC_TTbarDY/WGToLNuG_TuneCUETP8M1_13TeV-amcatnloFXFX-pythia8_ext2/analysisTree.root";   

      }else{
        fname = "/cms/mchristos/ANN/Seesaw/2016/92X/MC_notTTbarDY/WGToLNuG_TuneCUETP8M1_13TeV-amcatnloFXFX-pythia8_ext2/analysisTree.root";   
     }
	...
	TFile *endfile = new TFile("/cms/mchristos/ANN/Seesaw/2016/92X/TMVAskims/pyPlotter/Backgrounds/WGToLNuG_TuneCUETP8M1_13TeV-amcatnloFXFX-pythia8_ext2/analysisTree.root","RECREATE");
