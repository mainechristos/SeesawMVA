...
void makeSkims_pyPlotter(){
	...
	TFile *input(0);
	TString fname = "";
	std::string label ="TTWJetsToLNu_TuneCUETP8M1_13TeV-amcatnloFXFX-madspin-pythia8";   

	if( (label.find("TTJets_Dilept") != std::string::npos) || (label.find("DYJets") != std::string::npos) ){
        fname = "/cms/mchristos/ANN/Seesaw/2016/92X/MC_TTbarDY/TTWJetsToLNu_TuneCUETP8M1_13TeV-amcatnloFXFX-madspin-pythia8/analysisTree.root";   

      }else{
        fname = "/cms/mchristos/ANN/Seesaw/2016/92X/MC_notTTbarDY/TTWJetsToLNu_TuneCUETP8M1_13TeV-amcatnloFXFX-madspin-pythia8/analysisTree.root";   
     }
	...
	TFile *endfile = new TFile("/cms/mchristos/ANN/Seesaw/2016/92X/TMVAskims/pyPlotter/Backgrounds/TTWJetsToLNu_TuneCUETP8M1_13TeV-amcatnloFXFX-madspin-pythia8/analysisTree.root","RECREATE");
