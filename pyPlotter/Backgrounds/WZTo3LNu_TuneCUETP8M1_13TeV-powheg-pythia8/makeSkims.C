...
float dataType1Weight(int dataType, int Event, int LS, float LightLeptonTightTypeA, float LightLeptonLT3, float PFMETType1, float LightLeptonEta0, float LightLeptonEta1, float LightLeptonEta2, float LightLeptonEta3, float LightLeptonPt0, float LightLeptonPt1, float LightLeptonPt2, float LightLeptonPt3, int PULightLeptonFlavorType, int LightLeptonFlavorType3D, int LightLeptonFlavorType4D,int GenPileUpInteractionsTrue, int LightLeptonNonFakeTypeA, int LightLeptonN ){
	...
	if(LightLeptonN==3){
		...
		weight = (2*((Event+LS)%2==0)*(LightLeptonTightTypeA==111)*(leptonSF3D((LightLeptonLT3+PFMETType1),LightLeptonEta0,LightLeptonPt1,LightLeptonEta1,LightLeptonPt2,LightLeptonEta2,PULightLeptonFlavorType))*(trigEffSF3D((LightLeptonLT3+PFMETType1), LightLeptonPt1, LightLeptonPt2, LightLeptonEta0, LightLeptonEta1, LightLeptonEta2, LightLeptonFlavorType3D))*(pileupWeightsOffXsecMinus5(GenPileUpInteractionsTrue))*(LightLeptonNonFakeTypeA==111));
	
	}else if(LightLeptonN==4){
		weight = (2*((Event+LS)%2==0)*(LightLeptonTightTypeA==1111)*(leptonSF4D((LightLeptonLT3+PFMETType1),LightLeptonEta0,LightLeptonPt1,LightLeptonEta1,LightLeptonPt2,LightLeptonEta2,LightLeptonPt3,LightLeptonEta3,PULightLeptonFlavorType))*(trigEffSF4D((LightLeptonLT3+PFMETType1), LightLeptonPt1, LightLeptonPt2, LightLeptonPt3, LightLeptonEta0, LightLeptonEta1, LightLeptonEta2, LightLeptonEta3, LightLeptonFlavorType4D))*(pileupWeightsOffXsecMinus5(GenPileUpInteractionsTrue))*(LightLeptonNonFakeTypeA==1111));
	}
...
float dataType4Weight(int dataType, int Event, int LS, float LightLeptonTightTypeA, float LightLeptonLT3, float PFMETType1, float LightLeptonEta0, float LightLeptonEta1, float LightLeptonEta2, float LightLeptonEta3, float LightLeptonPt0, float LightLeptonPt1, float LightLeptonPt2, float LightLeptonPt3, int PULightLeptonFlavorType, int LightLeptonFlavorType3D, int LightLeptonFlavorType4D,int GenPileUpInteractionsTrue, int LightLeptonNonFakeTypeA, int LightLeptonN, int JetN ){
	...
	if(LightLeptonN==3){
		...
		weight = ((LightLeptonTightTypeA==111)*(leptonSF3D((LightLeptonLT3+PFMETType1),LightLeptonEta0,LightLeptonPt1,LightLeptonEta1,LightLeptonPt2,LightLeptonEta2,PULightLeptonFlavorType))*(trigEffSF3D((LightLeptonLT3+PFMETType1), LightLeptonPt1, LightLeptonPt2, LightLeptonEta0, LightLeptonEta1, LightLeptonEta2, LightLeptonFlavorType3D))*(pileupWeightsOffXsecMinus5(GenPileUpInteractionsTrue))*(LightLeptonNonFakeTypeA==111))*(jetWeights_WZ_powheg_2016(JetN));
	
	}else if(LightLeptonN==4){
		weight = ((LightLeptonTightTypeA==1111)*(leptonSF4D((LightLeptonLT3+PFMETType1),LightLeptonEta0,LightLeptonPt1,LightLeptonEta1,LightLeptonPt2,LightLeptonEta2,LightLeptonPt3,LightLeptonEta3,PULightLeptonFlavorType))*(trigEffSF4D((LightLeptonLT3+PFMETType1), LightLeptonPt1, LightLeptonPt2, LightLeptonPt3, LightLeptonEta0, LightLeptonEta1, LightLeptonEta2, LightLeptonEta3, LightLeptonFlavorType4D))*(pileupWeightsOffXsecMinus5(GenPileUpInteractionsTrue))*(LightLeptonNonFakeTypeA==1111))*(jetWeights_WZ_powheg_2016(JetN));
	}
...
float dataType5Weight(int dataType, int Event, int LS, float LightLeptonTightTypeA, float LightLeptonLT3, float PFMETType1, float LightLeptonEta0, float LightLeptonEta1, float LightLeptonEta2, float LightLeptonEta3, float LightLeptonPt0, float LightLeptonPt1, float LightLeptonPt2, float LightLeptonPt3, int PULightLeptonFlavorType, int LightLeptonFlavorType3D, int LightLeptonFlavorType4D,int GenPileUpInteractionsTrue, int LightLeptonNonFakeTypeA, int LightLeptonN){
	...
	if(LightLeptonN==3){
		...
		weight = ((LightLeptonTightTypeA==111)*(leptonSF3D((LightLeptonLT3+PFMETType1),LightLeptonEta0,LightLeptonPt1,LightLeptonEta1,LightLeptonPt2,LightLeptonEta2,PULightLeptonFlavorType))*(trigEffSF3D((LightLeptonLT3+PFMETType1), LightLeptonPt1, LightLeptonPt2, LightLeptonEta0, LightLeptonEta1, LightLeptonEta2, LightLeptonFlavorType3D))*(pileupWeightsOffXsecMinus5(GenPileUpInteractionsTrue))*(LightLeptonNonFakeTypeA==111));
...
void makeSkims(){
	...
	TFile *input(0);
	TString fname = "/cms/mchristos/ANN/Seesaw/2016/92X/MC_notTTbarDY/WZTo3LNu_TuneCUETP8M1_13TeV-powheg-pythia8/analysisTree.root";   
	input = TFile::Open(fname);
	std::cout << "--- Using input file: " << input->GetName() << std::endl;
	cout<<endl;
	float fileWeight;
	float xsec = 4.42965*1.07;
	...
	TFile *endfile = new TFile("/cms/mchristos/ANN/Seesaw/2016/92X/TMVAskims/Backgrounds/WZTo3LNu_TuneCUETP8M1_13TeV-powheg-pythia8/shortTree.root","RECREATE");
	...
	TTree *analysisTree = shortTree->CopyTree("L3AboveZ&&LightLeptonPairDR[0]>0.4&&LightLeptonN[0]==3&&SingleIsoLeptonTrigAccept2016>0&&LowMassVeto==1&&HasTriggerMatch_2016>0");
	analysisTree->Write();
	endfile->Close(); 
