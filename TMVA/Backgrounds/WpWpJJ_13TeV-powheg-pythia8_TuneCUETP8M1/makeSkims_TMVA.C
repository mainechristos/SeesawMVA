...
void makeSkims_TMVA(){
	...
	TFile *input(0);
	TString fname = "";
	std::string label ="WpWpJJ_13TeV-powheg-pythia8_TuneCUETP8M1";   

	if( (label.find("TTJets_Dilept") != std::string::npos) || (label.find("DYJets") != std::string::npos) ){
        fname = "/cms/mchristos/ANN/Seesaw/2016/92X/MC_TTbarDY/WpWpJJ_13TeV-powheg-pythia8_TuneCUETP8M1/analysisTree.root";   

      }else{
        fname = "/cms/mchristos/ANN/Seesaw/2016/92X/MC_notTTbarDY/WpWpJJ_13TeV-powheg-pythia8_TuneCUETP8M1/analysisTree.root";   
     }
	...
	TFile *endfile;
	if(nleptons==4){
		endfile = new TFile("/cms/mchristos/ANN/Seesaw/2016/92X/TMVAskims/TMVA/Backgrounds/WpWpJJ_13TeV-powheg-pythia8_TuneCUETP8M1/shortTree_4L.root","RECREATE");
	}
	else if(nleptons==3){
		endfile = new TFile("/cms/mchristos/ANN/Seesaw/2016/92X/TMVAskims/TMVA/Backgrounds/WpWpJJ_13TeV-powheg-pythia8_TuneCUETP8M1/shortTree_3L.root","RECREATE");
	}
