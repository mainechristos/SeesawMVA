...
void makeSkims_TMVA(){
	...
	TFile *input(0);
	TString fname = "";
	std::string label ="TTJets_Dilept_TuneCUETP8M2T4_13TeV-amcatnloFXFX-pythia8";   

	if( (label.find("TTJets_Dilept") != std::string::npos) || (label.find("DYJets") != std::string::npos) ){
        fname = "/cms/mchristos/ANN/Seesaw/2016/92X/MC_TTbarDY/TTJets_Dilept_TuneCUETP8M2T4_13TeV-amcatnloFXFX-pythia8/analysisTree.root";   

      }else{
        fname = "/cms/mchristos/ANN/Seesaw/2016/92X/MC_notTTbarDY/TTJets_Dilept_TuneCUETP8M2T4_13TeV-amcatnloFXFX-pythia8/analysisTree.root";   
     }
	...
	TFile *endfile;
	if(nleptons==4){
		endfile = new TFile("/cms/mchristos/ANN/Seesaw/2016/92X/TMVAskims/TMVA/Backgrounds/TTJets_Dilept_TuneCUETP8M2T4_13TeV-amcatnloFXFX-pythia8/shortTree_4L.root","RECREATE");
	}
	else if(nleptons==3){
		endfile = new TFile("/cms/mchristos/ANN/Seesaw/2016/92X/TMVAskims/TMVA/Backgrounds/TTJets_Dilept_TuneCUETP8M2T4_13TeV-amcatnloFXFX-pythia8/shortTree_3L.root","RECREATE");
	}
