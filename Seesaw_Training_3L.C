...
void Seesaw_Training_3L( TString myMethodList = "" )
{
   ...
   TString outfileName( "/cms/mchristos/ANN/Seesaw/2016/92X/TMVAskims/class_perf/92X_Seesaw_optimized.root" );
   TFile* outputFile = TFile::Open( outfileName, "RECREATE" );

   TMVA::Factory *factory = new TMVA::Factory( "92X_Seesaw_optimized", outputFile,
   ...
   while (std::getline(infileXsecs, lines)) {    //loops through remaining lines in xsecs file
      ...
      std::string in = "/cms/mchristos/ANN/Seesaw/2016/92X/TMVAskims/TMVA/Signal/"+process+"/shortTree.root";
   ...
   while (std::getline(infileb, lineb)) {    
      ...
      in = "/cms/mchristos/ANN/Seesaw/2016/92X/TMVAskims/TMVA/Backgrounds/"+bg+"/shortTree.root";
