...
void runData(TString ifile = ""){
  ...
  reader->AddVariable("LightLeptonLT := Alt$(LightLeptonLT3[0],0)", &LightLeptonLT3);
   ...
   TFile *endfile = new TFile("outFiles/Seesaw_Application_1/SingleElectron/Run2016C-03Feb2017-v1_MINIAOD/BDTtree.root","RECREATE");   
...
{   
   ...
   TString back_name = "/cms/mchristos/ANN/Seesaw/2016/92X/Data/SingleElectron/Run2016C-03Feb2017-v1_MINIAOD/analysisTree_3L.root";
