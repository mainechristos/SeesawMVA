...
reader->AddVariable("LightLeptonLT := Alt$(LightLeptonLT3[0],0)", &LightLeptonLT3);
   ...
   TFile *endfile = new TFile("/cms/mchristos/ANN/Seesaw/2016/92X/TMVAskims/outFiles/Seesaw_Application_1/Background/ttHToNonbb_M125_TuneCUETP8M2_ttHtranche3_13TeV-powheg-pythia8/BDTtree.root","RECREATE");   
...
{   
   ...
   TString back_name = "/cms/mchristos/ANN/Seesaw/2016/92X/TMVAskims/pyPlotter/Backgrounds/ttHToNonbb_M125_TuneCUETP8M2_ttHtranche3_13TeV-powheg-pythia8/analysisTree.root";
