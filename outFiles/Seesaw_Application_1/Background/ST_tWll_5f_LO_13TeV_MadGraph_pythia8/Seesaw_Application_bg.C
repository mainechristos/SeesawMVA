...
reader->AddVariable("LightLeptonLT := Alt$(LightLeptonLT3[0],0)", &LightLeptonLT3);
   ...
   TFile *endfile = new TFile("/cms/mchristos/ANN/Seesaw/2016/92X/TMVAskims/outFiles/Seesaw_Application_1/Background/ST_tWll_5f_LO_13TeV_MadGraph_pythia8/BDTtree.root","RECREATE");   
...
{   
   ...
   TString back_name = "/cms/mchristos/ANN/Seesaw/2016/92X/TMVAskims/pyPlotter/Backgrounds/ST_tWll_5f_LO_13TeV_MadGraph_pythia8/analysisTree.root";
