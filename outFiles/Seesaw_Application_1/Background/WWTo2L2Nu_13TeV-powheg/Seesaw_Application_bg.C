...
reader->AddVariable("LightLeptonLT := Alt$(LightLeptonLT3[0],0)", &LightLeptonLT3);
   ...
   TFile *endfile = new TFile("outFiles/Seesaw_Application_1/Background/WWTo2L2Nu_13TeV-powheg/BDTtree.root","RECREATE");   
...
{   
   ...
   TString back_name = "pyPlotter/Backgrounds/WWTo2L2Nu_13TeV-powheg/analysisTree.root";
